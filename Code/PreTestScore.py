# -*- coding: utf-8 -*-
"""
Created on Thu Apr 18 21:33:55 2024
...
class PreTestScore:
    ...
    def order_prioritization(self,database):
        ...
        order = sorted(order, key=lambda x:x[10], reverse=True)
        #print('\n---------------------------------------------------------------------------------------------------------')
        #print('\n\033[1m'+'IMAGE ACQUISITION ORDER'+'\033[0m\n')
        #print(tabulate(order,headers=['ID','Age','Sex','Chest pain','Diabetes','Hypertension','Dyslipidaemia','Smoking','CACs','Model','%risk']))
        return order