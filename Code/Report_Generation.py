class Report_Generation:
    def __init__(self):   
        # segments name in the database for right dominance patients
        ...
        # segments name in the database for left dominance patients
        ...
        # segments name in the database for codominance patients
        ...
        # vessels name in database and how they should be reported
        # vessels with one segment
        ...
        # vessels with two segment
        self.two_segments_tree = {'p-Cx':'\n·Circumflex artery (Cx)'
                                  }
        
        # vessels with three segment
        self.three_segments_tree = {'p-LAD':'\n·Left anterior descending artery (LAD)',
                                    'p-RCA':'\n·Right coronary artery (RCA)'
                                    }
        
        # stenosis range and their corresponding way to report
        ...
        # coronary artery calcium score range and their corresponding way to report
    ...
    def final_reporting(self,data,identifier):
        ...
        # title for coronary study report
        ...
        for j in data[identifier]['Stenosis']:
            ...
            if data[identifier]['Stenosis'][j][1]!='0': # count vessels affected
                var+=1
        
        # record level of stenosis of each segment
        results_stenosis = {}
        ...
        # record corresponding phrase of template with the corresponding findings for the report
        for artery in vessels_name_list:
            ...
            # three segment vessels
            if len(artery) == 3:
                self.three_segments(report,results_stenosis,artery)
                    
        #Report calcium score too high
        ...
        # add additional comments in report if introduced in the reporting system
        try:
            report.append('\nADDITIONAL COMMENTS: ')
        ...
        # report of findings if the study is a non-diagnostic case
        if CADRADS == 'ND':
            #Report conclusions
            report.append('\nCONCLUSIONS:')
            report.append('NON-diagnostic study\n')
        
        # report of findings if the study is not a non-diagnostic case
        else:
            #Report conclusions
            report.append('\nCONCLUSIONS: ')
            ...
            #Report CAD-RADS (following reporting guidelines of CAD-RADS 2.0: https://www.ncbi.nlm.nih.gov/pmc/articles/PMC9627235/)
    ...
    # method to report image findings for one segment vessel
    ...
    # method to report image findings for two segments vessel
    ...
    # method to report image findings for three segments vessel
